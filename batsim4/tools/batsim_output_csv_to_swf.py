...
for row in reader:
    ...
    print(f'batsim_output_csv_to_swf.py || job_id = {job_id} || walltime = {wall_time} = requestedtime[{float(row["requested_time"])}], run_time= execution_time[ {float(row["execution_time"])}]')
